...
INICIO:
	...
	case 2:
		...
		empresa.readclients("clients01.txt");
		empresa.writeClients("clients02.txt");
		empresa.readTickets("tickets01.txt");
		empresa.writeTickets("tickets02.txt");
		rotinaEmpresa(empresa);
		break;
	case 0:
		return 0;
...
CRIA_BRANCH:
	case 5:
		...
		if (proj->getTipo() == "Basico") {
			cout << "\n*Este � do tipo Basico (sem branches)*\n"
