...
public:
	...
	/**
	 * @brief Adiciona o projeto fornecido � empresa
	...
	/**
	 * @brief Verifica se o utilizador com nome fornecido j� existe, lancando exece�ao se n�o existir nenhum com esse nome
	 * @param nome - nome do utilizador a verigicar se j� existe ou n�o
	 */
	...
	*/
	 ...
	 * @return verdadeiro se n�o conseguir realizar a convers�o, caso contr�rio retorna falso
	 */
	...
	/**
	 * @brief Adiciona cliente � �rvore bin�ria com os clientes da empresa
	 * @param c - cliente a adicionar � empresa
	 */
	void addClient(Client c);

	/**
	 * @brief Remove cliente da �rvore bin�ria com os clientes da empresa
	...
	/**
	 * @brief Coloca projeto na tabela de dispers�o dos projetos terminados, removendo-o dos projetos em desenvolvimento
	...
	/**
	 * @brief Adiciona projeto � tabela de dispers�o dos projetos terminados
	 * @param proj - projeto a ser adicionado aos projetos terminados
	 */
	void addPastProject (Projeto* proj);

	/**
	 * @brief Remove projeto da tabela de dispers�o dos projetos terminados, lan�ando exce��o se n�o existir nenhum projeto com o id fornecido
	 * @param proj - projeto a ser removido dos projetos terminados
	 */
	void removePastProject (unsigned int id);

	/**
	 * @brief Procura o projeto terminado com id fornecido, lan�ando exce��o se n�o o encontrar
	 ...
	 * @return verdaderio se a opera��o � efetuada com sucesso, senao retorna falso
	 */
