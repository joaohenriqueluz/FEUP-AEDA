...
public:
	...
	/**
	 * @brief Verifica se o utilizador com nome fornecido ja existe, lancando exece�ao se nao existir nenhum com esse nome
	...
	/**
	 * @brief Adiciona cliente � arvore binaria com os clientes da empresa
	...
	/**
	 * @brief Adiciona projeto � tabela de dispersao dos projetos terminados
	 * @param proj - projeto a ser adicionado aos projetos terminados
	 */
	void addPastProject (Projeto* proj);

	/**
	 * @brief Remove projeto da tabela de dispersao dos projetos terminados, lan�ando exce�ao se nao existir nenhum projeto com o id fornecido
	 * @param proj - projeto a ser removido dos projetos terminados
	 */
	void removePastProject (unsigned int id);

	/**
	 * @brief Procura o projeto terminado com id fornecido, lan�ando exce�ao se nao o encontrar
	 ...
	 * @return verdaderio se a opera�ao � efetuada com sucesso, senao retorna falso
	 */
